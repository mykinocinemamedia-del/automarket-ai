...
/**
 * Generate page-specific prompt suggestions (client-safe, no server imports)
 */
export function getPagePrompts(section: string): string[] {
  const context = getPageContext(section)
  const prompts: Record<string, string[]> = {
    dashboard: [
      'What should I focus on this week?',
      'Generate a content plan for the next 7 days',
      'Which platform is underperforming?',
      'Create 3 posts for tomorrow',
    ],
    projects: [
      'What type of project should I create?',
      'How do I organize multiple clients?',
      'Suggest a content strategy for a new client',
    ],
    trends: [
      "What's trending in my industry right now?",
      'Generate 5 trend-jacking post ideas',
      'Which trends fit my brand?',
    ],
    agent: [
      'Help me plan a campaign',
      'What questions will you ask me?',
      'Generate a month of content for Instagram',
    ],
    studio: [
      'Write a caption about our new product',
      'Generate trending hashtags for coffee',
      'Repurpose this for LinkedIn: [paste content]',
      'Give me 10 content ideas for this week',
    ],
    brand: [
      'How can I improve my brand voice?',
      'Generate 3 caption examples in my brand voice',
      "What's missing from my brand profile?",
      'Suggest hashtag sets for my industry',
    ],
    calendar: [
      'Fill my empty calendar slots',
      "What's the best time to post on Instagram?",
      'Generate posts for this weekend',
      'Balance my content mix',
    ],
    assets: [
      'What images do I need for next week?',
      'Suggest a content template',
    ...
    autopilot: [
      'What automation rules should I create?',
      'Suggest a daily posting schedule',
      'How do I auto-repurpose content?',
    ],
  }

  return prompts[section] || context.availableActions
}
